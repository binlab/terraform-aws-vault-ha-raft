...
| <a name="input_docker_tag"></a> [docker\_tag](#input\_docker\_tag) | Vault Docker image version tag | `string` | `"1.4.2"` | no |
...
| <a name="output_node_security_group"></a> [node\_security\_group](#output\_node\_security\_group) | Node Security Group ID which allow connecting from vpc and alb <br>security groups |
